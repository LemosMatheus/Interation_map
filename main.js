...
link4.addEventListener("dblclick", ()=> {window.open("index.html", "_blank"); bmap2.style.display = "none"})
...
link4_mapa2.addEventListener("dblclick", ()=> {window.open("index.html", "_blank"); bmap3.style.display = "none"})
...
link3_mapa4.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))
console.log(fases)