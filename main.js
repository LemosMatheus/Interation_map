...
link4.addEventListener("dblclick", ()=> {window.open("generic.html", "_blank"); bmap2.style.display = "none"})
...
link4_mapa2.addEventListener("dblclick", ()=> {window.open("generic.html", "_blank"); bmap3.style.display = "none"})
...
link4_mapa3.addEventListener("dblclick", ()=> {window.open("generic.html", "_blank"); bmap4.style.display = "none"})
