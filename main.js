...
//MAPA3
link1_mapa3.addEventListener("click", ()=> perso3.style.animation = "fase1_mapa3 4s ease forwards")
link1_mapa3.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))

link2_mapa3.addEventListener("click", ()=> perso3.style.animation = "fase2_mapa3 4s ease forwards")
link2_mapa3.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))

link3_mapa3.addEventListener("click", ()=> perso3.style.animation = "fase3_mapa3 4s ease forwards")
link3_mapa3.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))

link4_mapa3.addEventListener("click", ()=> perso3.style.animation = "fase4_mapa3 4s ease forwards")
link4_mapa3.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))

//MAPA4
link1_mapa4.addEventListener("click", ()=> perso4.style.animation = "fase1_mapa4 4s ease forwards")
link1_mapa4.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))

link2_mapa4.addEventListener("click", ()=> perso4.style.animation = "fase2_mapa4 4s ease forwards")
link2_mapa4.addEventListener("dblclick", ()=> window.open("index.html", "_blank"))

link3_mapa4.addEventListener("click", ()=> perso4.style.animation = "fase3_mapa4 4s ease forwards")
console.log(fases)